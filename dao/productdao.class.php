<?php
    ...
    class ProductDAO {
        ...
        public function changeProduct($p)
        {
            try 
            {
                $stat = $this->connection->prepare("update product set name=?, author=?, description=?, category=?, quantity=?, price=?where productId = ?");
        ...
        public function changeFile($p)
        {
            try 
            {
            $stat = $this->connection->prepare("update product set imageUrl=? where productId = ?");
        ...
        public function changeQuantity($productId, $quantity)
        {
            try 
            {
            $stat = $this->connection->prepare("update product set quantity = quantity - ? where productId=?");
